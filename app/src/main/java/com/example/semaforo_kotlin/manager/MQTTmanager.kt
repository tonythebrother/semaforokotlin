...
class MQTTmanager (val connectionParams: MQTTConnectionParams, var context: Context, val uiUpdater: UIUpdaterInterface?) {
...
data class MQTTConnectionParams(val clientId:String, val host: String, val topic: String, val topic2: String, val username: String, val password: String){
